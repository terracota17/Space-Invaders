...
public class Messages {
	...
	public static final String PLAYER_LIFE_POINTS = "Life: %d";
	
	public static final String PLAYER_POINTS = "Points: %d";
	...
	public static final String PARSE_INTEGER_ERROR = "Oops :/ Unable to parse '%s' as an Integer in line \\\"%s\\\" ";
	
	public static final String INSUFFICENT_PARAMETERS = ".Insufficient parameters.";
